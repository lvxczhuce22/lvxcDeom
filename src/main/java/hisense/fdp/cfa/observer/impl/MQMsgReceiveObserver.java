 ...
 * 
 */
public class MQMsgReceiveObserver implements IObserver {
	public static final Logger log = LoggerFactory.getLogger(MQMsgReceiveObserver.class);
	...
	public void handleAction(Object obj) {
		...
		log.info("[消息已入队列] 队列当前长度（MQ）：" + eventQueue.size());
	}
